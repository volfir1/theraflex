...
<div class="button-wrapper"> 
      <div class="fixed flex mt-16 space-x-8 -translate-x-1/2 right-10 top-20 button-group">
            <a href="#massage-section" class="px-6 py-2 text-green-500 bg-white border border-gray-300 rounded-full hover:bg-gray-100">Massage</a>
            <a href="#sauna-section" class="px-6 py-2 bg-white border border-gray-300 rounded-full hover:bg-gray-100">Sauna</a>
            <a href="#bundles-section" class="px-6 py-2 bg-white border border-gray-300 rounded-full hover:bg-gray-100">Bundles</a>
          </div>
</div>
...
<div class="min-h-screen py-0 bg-gray-100 custom-font-body">
    <div class="menu-container ml-14">
        ...
        <div class="grid grid-cols-3 gap-8 px-5 pt-3" id="massage-section">
            ...
            <div class="transition duration-500 transform bg-white shadow-xl rounded-xl hover:scale-105">
                <div class="flex items-start p-5"> <img src="images/deeptissue.jpg" alt="Swedish Massage" class="w-32 h-32 mr-5 rounded-xl">
                    <div class="flex flex-col flex-grow">
                        <h2 class="pb-3 text-xl font-bold custom-font-heading">Deep Tissue Massage</h2>
                        <p class="text-sm">Description: Targets deep layers of muscle <br>Intensity: High<br>Duration: 60 minutes</p>
                        <div class="flex items-center justify-between py-4 mt-auto">
                            <p class="text-2xl font-semibold text-startcustom-font-heading">₱1500</p>
                            <button class="flex items-center px-6 py-2 font-bold text-white transition duration-300 ease-in-out rounded-lg bg-customcolor3 hover:bg-customcolor4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 0a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
            ...
            <div class="transition duration-500 transform bg-white shadow-xl rounded-xl hover:scale-105">
                <div class="flex items-start p-5"> <img src="images/hotstone.jpg" alt="Swedish Massage" class="w-32 h-32 mr-5 rounded-xl">
                    <div class="flex flex-col flex-grow">
                        <h2 class="pb-3 text-xl font-bold custom-font-heading">Hot Stone Massage</h2>
                        <p class="text-sm">Description: Uses heated stones to relax <br>Intensity: Medium<br>Duration: 75 minutes</p>
                        <div class="flex items-center justify-between py-4 mt-auto">
                            <p class="text-2xl font-semibold ml-44 text-startcustom-font-heading">₱2000</p>
                            <button class="flex items-center px-6 py-2 font-bold text-white transition duration-300 ease-in-out rounded-lg bg-customcolor3 hover:bg-customcolor4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 0a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
        ...
        <div class="grid grid-cols-3 gap-8 px-5" id="oil-section">
            ...
            <div class="transition duration-500 transform bg-white shadow-xl rounded-xl hover:scale-105">
                <div class="flex items-start p-5">
                    <img src="oils/Eucalyptus.jpg" alt="Eucalyptus Oil" class="w-32 h-32 mr-5 rounded-xl">
                    <div class="flex flex-col flex-grow">
                        <h2 class="pb-3 text-xl font-bold custom-font-heading">Eucalyptus Oil</h2>
                        <p class="text-sm">With its strong scent, it’s a popular choice for steam rooms and saunas. It’s also known for its ability to help clear the sinuses.</p>
                        <div class="flex items-center justify-between py-4 mt-auto">
                            <p class="text-2xl font-semibold text-startcustom-font-heading">Price: ₱100</p>
                            <button class="flex items-center px-6 py-2 font-bold text-white transition duration-300 ease-in-out rounded-lg bg-customcolor3 hover:bg-customcolor4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 0a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
            ...
            <div class="transition duration-500 transform bg-white shadow-xl rounded-xl hover:scale-105">
                <div class="flex items-start p-5">
                    <img src="oils/Peppermint.jpg" alt="Peppermint Oil" class="w-32 h-32 mr-5 rounded-xl">
                    <div class="flex flex-col flex-grow">
                        <h2 class="pb-3 text-xl font-bold custom-font-heading">Peppermint Oil</h2>
                        <p class="text-sm">Known for its invigorating properties, it’s often used in sports massages.</p>
                        <div class="flex items-center justify-between py-4 mt-auto">
                            <p class="text-2xl font-semibold text-startcustom-font-heading">Price: ₱300</p>
                            <button class="flex items-center px-6 py-2 font-bold text-white transition duration-300 ease-in-out rounded-lg bg-customcolor3 hover:bg-customcolor4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 0a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
