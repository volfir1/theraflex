...
<div class="mb-4">
    ...
    <textarea id="Description" name="Description" value = "{{$query->description}}"  class="w-full px-3 py-2 mb-3 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"></textarea>
</div>
<div class="flex mb-4">
