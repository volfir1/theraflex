...
<div class="flex items-center justify-center py-40">
    <div class="w-6/12 pr-10 mt-20 bg-white shadow-2xl pb-14 rounded-xl">
        ...
        <form class="pl-10 pr-10">
            ...
            <label for="appointmentDate" class="block mb-2 font-bold text-gray-700">Re-Schedule Date:</label>
                <input type="date" id="appointmentDate" name="appointmentDate" class="px-4 py-2 mb-2 ml-5 font-bold text-black bg-white border border-green-500 rounded-xl">

                <label for="appointmentTime" class="block mb-2 ml-10 font-bold text-gray-700">Re-Schedule Time:<Time:s></Time:s></label>
                <input type="time" id="appointmentTime" name="appointmentTime" class="px-4 py-2 mb-2 ml-5 font-bold text-black bg-white border border-green-500 rounded-xl">
            </div>
